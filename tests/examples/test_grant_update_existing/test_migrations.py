...
def test_apply_autogenerated_revision(alembic_runner: MigrationContext, alembic_engine):
    ...
    alembic_engine.execute(text("SET ROLE o2_read; INSERT INTO foo VALUES (DEFAULT)"))
    alembic_engine.execute(text("SET ROLE o2_read; UPDATE foo set id=DEFAULT"))
    alembic_engine.execute(text("SET ROLE o2_read; DELETE FROM foo"))
    ...
    alembic_engine.execute(text("SET ROLE o1_app; UPDATE foo set id=DEFAULT"))
    alembic_engine.execute(text("SET ROLE o1_app; DELETE FROM foo"))
