...
from sqlalchemy_declarative_extensions.model.query import model_query
...
def declarative_database(
    ...
    def _declare_database(cls: Type[DeclarativeMeta]) -> Type[DeclarativeMeta]:
        ...
        raw_models = getattr(cls, "models", None)
...
def declare_database(
    ...
    *,
    ...
    models: Union[None, Iterable[Model], Models] = None,
):
    ...
    Arguments:
        ...
        models: The set of models to ensure are applied to the roles/schemas/tables.
    """
    ...
    concrete_models = metadata.info["models"] = Models.coerce_from_unknown(models)
